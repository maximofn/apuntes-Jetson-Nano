...
def osd_sink_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame is not None:
        ...
        py_nvosd_text_params.display_text = "Vehicle_count={} Person_count={} Bicycle_count={}".format(obj_counter[PGIE_CLASS_ID_VEHICLE], 
                                                                       obj_counter[PGIE_CLASS_ID_PERSON], obj_counter[PGIE_CLASS_ID_BICYCLE])
